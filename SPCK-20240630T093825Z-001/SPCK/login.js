      ...
      <div class="col-lg-8">
        <div class="card-body py-5 px-md-5">
          ...
          <form>
            ...
            <!-- Submit button -->
            <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4 btnLogin">Login</button>
          </form>
...
`;
  ...
  btnLogin.addEventListener("click", async function () {
    if (email.value == "" || password.value == "") {
      ...
      const { infoMessage, isSuccess } = await dangnhap(
        auth,
        email.value,
        password.value
      );
